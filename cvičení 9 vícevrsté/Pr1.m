...
syms Re r r1 r2 r3 p delt kk A1 B1 A2 B2 ps p E mu
...
sigmaZ1R2 = (sigmaR1 + sigmaT1)/2
sigmaZ2R2 = (sigmaR2 + sigmaT2)/2
...
fplot(p1, [0 0.1], 'color','red')
hold on
fplot(p2, [0 0.1], 'color','blue')
hold off

rce8 = p1 == p2
delt = solve(rce8,delt)
